...
using DbFirstApproach_Nishna.Models;

namespace DbFirstApproach_Nishna.Controllers
{
    public class EnrollmentsController : Controller
    {
        private readonly UniversityNishnaContext _context;

        public EnrollmentsController(UniversityNishnaContext context)
        {
            _context = context;
        }
        ...
        {
            var universityNishnaContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await universityNishnaContext.ToListAsync());
        }
